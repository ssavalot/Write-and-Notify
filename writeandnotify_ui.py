...
class Ui_writeandnotify_MainWindow(object):
    def setupUi(self, writeandnotify_MainWindow):
        ...
        writeandnotify_MainWindow.resize(268, 343)
        ...
        self.email_lineEdit.setMinimumSize(QtCore.QSize(0, 26))
        ...
        self.password_lineEdit.setMinimumSize(QtCore.QSize(0, 26))
        ...
        self.subject_lineEdit.setMinimumSize(QtCore.QSize(0, 26))
        self.subject_lineEdit.setFrame(False)
        ...
        self.copy_to_lineEdit.setMinimumSize(QtCore.QSize(0, 26))
        ...
        self.cancel_pushButton.setFlat(False)
        ...
        self.execute_pushButton.setFlat(False)
